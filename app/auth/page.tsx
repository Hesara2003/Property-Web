          ...
          <TabsContent value="signup">
            <Card>
              <CardHeader className="text-center">
                ...
                <CardDescription>Join PropertyHub to start finding your perfect property match</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="mb-6 p-4 bg-muted/50 rounded-lg border border-border">
                  <h4 className="font-medium text-sm mb-2 text-foreground">Demo Credentials</h4>
              ...
              <CardContent>
                <form onSubmit={handleForgotPassword} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Mail className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                      <Input id="resetEmail" type="email" placeholder="john@example.com" className="pl-10" required />
                    </div>
                  </div>
                ...
                <div className="mt-4 text-center">
                  <Button variant="link" className="text-sm" type="button" onClick={() => setActiveTab("login")}>
                    Back to Sign In
                  </Button>
                </div>
              </CardContent>
        ...
        <div className="text-center text-sm text-muted-foreground">
          {activeTab === "signup" ? (
            ...
            <>
              ...
              <Button variant="link" className="px-0 text-sm" onClick={() => setActiveTab("signup")}>
                Sign up
              </Button>
            </>
          )}
